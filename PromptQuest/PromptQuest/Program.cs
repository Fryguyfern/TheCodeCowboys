...
var environment = builder.Services.BuildServiceProvider().GetService<IWebHostEnvironment>();
...
builder.Services.AddDbContext<GameStateDbContext>(options =>
	options.UseSqlServer(builder.Configuration["ConnectionString-GameStateDb"]));
